...
export function defaultReliabilityScenarios(
  ...
  return [
    ...
    scenario("tutor_turn", "First-party Tutor turn and release-gated graph update", "pwa", {
      journey: ["PWA Tutor mode selection", "POST /api/tutor/turn", "POST /api/graph/user/replay"],
      targetRps: 10 * scale,
