...
- PWA Admin surface includes incident command metrics, local incident artifact previews, queued backend-compatible `POST /api/ops/incidents/reports` replay, Privacy Ops cards for export, voice deletion, health deletion, and account deletion alongside the service map and audit log.
